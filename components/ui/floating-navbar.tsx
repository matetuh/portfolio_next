      ...
      >
        ...
        {navItems.map((navItem: any, idx: number) => (
          <a
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center flex px-3 py-2 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500"
            )}
